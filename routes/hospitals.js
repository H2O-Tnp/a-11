...
*               $ref: '#/components/schemas/Hospital'
*       404:
*         description: The hospital was not foun
*/
...
router.route('/:id').get(getHospital).put(protect, authorize('admin'), updateHospital).delete(protect, authorize('admin'), deleteHospitals);
